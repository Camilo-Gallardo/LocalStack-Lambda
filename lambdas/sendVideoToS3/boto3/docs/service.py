...
from botocore.docs.service import (
    ServiceDocumenter as BaseServiceDocumenter,
)
...
class ServiceDocumenter(BaseServiceDocumenter):
    ...
    EXAMPLE_PATH = os.path.join(
        os.path.dirname(boto3.__file__),
        "examples",
    )
    ...
    def _document_service_resource(
        ...
        service_resource_doc.write_to_file(
            service_resource_dir_path,
            "index",
        )
    ...
    def _document_resources(
        ...
        for resource_name in json_resource_model["resources"]:
            ...
            resource_doc = DocumentStructure(
                resource_name,
                target="html",
            )
