...
class parser(object):
    ...
    def _build_tzaware(self, naive, res, tzinfos):
        if callable(tzinfos) or (tzinfos and res.tzname in tzinfos):
            ...
            # with it
            warnings.warn(
                "tzname {tzname} identified but not understood.  " "Pass `tzinfos` argument in order to correctly " "return a timezone-aware datetime.  In a future " "version, this will raise an " "exception.".format(tzname=res.tzname),
    ...
    def parse(self, tzstr):
        ...
        try:
            ...
            if i >= len_l:
                ...
                warn(
                    ('Parsed time zone "%s"' % tzstr) + "is in a non-standard dateutil-specific format, which " + "is now deprecated; support for parsing this format " + "will be removed in future versions. It is recommended " + "that you switch to a standard format like the GNU " + "TZ variable format.",
