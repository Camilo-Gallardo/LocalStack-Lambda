...
class relativedelta(
        ...
        if (
            ...
            if isinstance(
                ...
                if not isinstance(
                    ...
                    dt1 = datetime.datetime.fromordinal(
                        dt1.toordinal()
                    )
                elif not isinstance(
                    dt2,
                    ...
                    dt2 = datetime.datetime.fromordinal(
                        dt2.toordinal()
                    )
    ...
    def __add__(
        ...
        if not isinstance(
            ...
            other = datetime.datetime.fromordinal(
                other.toordinal()
            )
        year = (
            (
