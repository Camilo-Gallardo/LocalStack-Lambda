...
class Functions(
    ...
    def _type_check_single(
        ...
        if (
            ...
            raise exceptions.JMESPathTypeError(
                function_name,
                current,
                self._convert_to_jmespath_type(
                    actual_typename
                ),
                types,
            )
    ...
    def _create_key_func(
        ...
        def keyfunc(
            ...
            jmespath_type = self._convert_to_jmespath_type(
                actual_typename
            )
