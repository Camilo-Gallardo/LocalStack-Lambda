...
class Lexer(
    ...
    def tokenize(
        ...
        self._initialize_for_expression(
            expression
        )
        while (
            self._current
            ...
            if (
                self._current
                in self.SIMPLE_TOKENS
            ):
                yield {
                    "type": self.SIMPLE_TOKENS[
                        self._current
                    ],
                    "value": self._current,
    ...
    def _initialize_for_expression(
        self,
        expression,
    ):
        if (
    ...
    def _consume_quoted_identifier(
        self,
    ):
        start = (
            self._position
    ...
    def _consume_raw_string_literal(
        self,
    ):
        start = (
            self._position
