...
class TreeInterpreter(
    ...
    def __init__(
        ...
        if (
            ...
            self._functions = (
                self._options.custom_functions
            )
        else:
            self._functions = (
                functions.Functions()
    ...
    def visit_comparator(
        ...
        comparator_func = self.COMPARATOR_FUNC[
            node[
                "value"
            ]
        ]
    ...
    def visit_not_expression(
        self,
        node,
        value,
    ):
        original_result = self.visit(
            node[
                "children"
            ][
                0
