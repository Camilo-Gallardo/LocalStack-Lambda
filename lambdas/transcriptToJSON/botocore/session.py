...
class Session:
    ...
    def __init__(
        ...
        self.session_var_map = SessionVarDict(
            self,
    ...
    def _register_token_provider(
        ...
        self._components.lazy_register_component(
            "token_provider",
            self._create_token_resolver,
        )

    def _create_token_resolver(
        self,
    ):
        return botocore.tokens.create_token_resolver(
            self
        )

    def _register_credential_provider(
        self,
    ):
        self._components.lazy_register_component(
            "credential_provider",
    ...
    def _create_credential_resolver(
        self,
    ):
    ...
    def _register_endpoint_resolver(
        self,
    ):
        def create_default_resolver():
            loader = self.get_component(
                "data_loader"
            )
            (
                endpoints,
            ...
            uses_builtin = loader.is_builtin_path(
                path
            )
            return EndpointResolver(
                endpoints,
                uses_builtin_data=uses_builtin,
            )
    ...
    def _register_default_config_resolver(
        self,
    ):
        ...
        self._internal_components.lazy_register_component(
            ...
            create_default_config_resolver,
        )
    ...
    def _register_response_parser_factory(
        self,
    ):
        self._components.register_component(
    ...
    def _register_exceptions_factory(
        self,
    ):
    ...
    def _register_monitor(
        ...
        self._internal_components.lazy_register_component(
            "monitor",
            self._create_csm_monitor,
        )

    def _register_user_agent_creator(
        self,
    ):
        uas = (
            UserAgentString.from_environment()
        )
        self._components.register_component(
            "user_agent_creator",
            uas,
    ...
    def _create_csm_monitor(
        self,
    ):
        if self.get_config_variable(
            "csm_enabled"
        ):
            client_id = self.get_config_variable(
                "csm_client_id"
            )
            host = self.get_config_variable(
                "csm_host"
            )
            port = self.get_config_variable(
                "csm_port"
            )
    ...
    def _get_crt_version(
        ...
        user_agent_creator = self.get_component(
            "user_agent_creator"
        )
        return (
            user_agent_creator._crt_version
            or "Unknown"
        )
    ...
    def _build_profile_map(
        ...
        if (
            ...
            self._profile_map = self.full_config[
                "profiles"
            ]
        return (
            self._profile_map
    ...
    def profile(
        ...
        if (
            ...
            profile = self.get_config_variable(
                "profile"
            )
    ...
    def _get_config_variable_with_custom_methods(
        self,
        logical_name,
        methods,
    ):
        ...
        chain_builder = SubsetChainConfigFactory(
            session=self,
            methods=methods,
        )
        mapping = create_botocore_default_config_mapping(
        ...
        for (
            ...
            mapping[
                name
            ] = chain_builder.create_config_chain(
                **build_chain_config_args
            )
        config_store_component = ConfigValueStore(
            mapping=mapping
        )
        value = config_store_component.get_config_variable(
            logical_name
        )
        return value
    ...
    def get_scoped_config(
        ...
        """
        profile_name = self.get_config_variable(
            "profile"
        )
        profile_map = (
    ...
    def full_config(
        ...
        **entire** config file.
        ...
        if (
            ...
            try:
                config_file = self.get_config_variable(
                    "config_file"
                )
                self._config = botocore.configloader.load_config(
                    config_file
                )
            ...
            try:
                ...
                # profile.
                cred_file = self.get_config_variable(
                    "credentials_file"
                )
    ...
    def get_auth_token(
        ...
        if (
            ...
            provider = self._components.get_component(
                "token_provider"
            )
            self._auth_token = (
                provider.load_token()
    ...
    def get_service_model(
        ...
        """
        service_description = self.get_service_data(
            service_name,
            api_version,
        )
        return ServiceModel(
    ...
    def get_paginator_model(
        ...
        return paginate.PaginatorModel(
            paginator_config
        )
    ...
    def get_service_data(
        ...
        service_data = self.get_component(
            "data_loader"
        ).load_service_model(
            data_path,
            type_name="service-2",
    ...
    def emit_first_non_none_response(
        ...
        **kwargs,
        ...
        responses = self._events.emit(
            event_name,
            **kwargs,
        )
        return first_non_none_response(
            responses
        )
    ...
    def get_component(
        ...
        try:
            ...
            if (
                ...
                return self._internal_components.get_component(
                    name
                )
            raise

    def _get_internal_component(
        self,
        name,
    ):
    ...
    def _register_internal_component(
        self,
        name,
        component,
    ):
        ...
        # Session, this method should **never** be used by a class that lives
        # outside of botocore.
        return self._internal_components.register_component(
            name,
            component,
        )
    ...
    def create_client(
        ...
        default_client_config = (
            self.get_default_client_config()
        )
        ...
        if (
            config
            is not None
            and default_client_config
            is not None
        ):
            config = default_client_config.merge(
                config
            )
        ...
        if (
            ...
            verify = self.get_config_variable(
                "ca_bundle"
            )
        ...
        if (
            ...
            api_version = self.get_config_variable(
                "api_versions"
            ).get(
                service_name,
                None,
        ...
        event_emitter = self.get_component(
            "event_emitter"
        )
        ...
        endpoint_resolver = self._get_internal_component(
            "endpoint_resolver"
        )
        exceptions_factory = self._get_internal_component(
            "exceptions_factory"
        )
        config_store = copy.copy(
            self.get_component(
                "config_store"
            )
        )
        ...
        defaults_mode = self._resolve_defaults_mode(
            config,
            config_store,
        )
        if (
    ...
    def _resolve_region_name(
        ...
        if (
            ...
            if (
                ...
                region_name = self.get_config_variable(
                    "region"
                )
    ...
    def _resolve_defaults_mode(
        self,
        client_config,
        config_store,
    ):
        mode = config_store.get_config_variable(
            "defaults_mode"
        )

        if (
            client_config
            and client_config.defaults_mode
        ):
            mode = (
                client_config.defaults_mode
            )
        ...
        default_modes = (
            default_config_resolver.get_default_modes()
        )
        lmode = (
            mode.lower()
        )
    ...
    def _add_configured_endpoint_provider(
        self,
        client_name,
        config_store,
    ):
    ...
    def get_available_partitions(
        ...
        """
        resolver = self._get_internal_component(
            "endpoint_resolver"
        )
        return (
    ...
    def get_partition_for_region(
        ...
        return resolver.get_partition_for_region(
            region_name
        )
...
class SessionVarDict(
    ...
    def __setitem__(
        ...
        self._update_config_store_from_session_vars(
            key,
            value,
        )
    ...
    def _update_config_store_from_session_vars(
        ...
        config_store = self._session.get_component(
            "config_store"
        )
        config_store.set_config_provider(
            logical_name,
...
class SubsetChainConfigFactory:
    ...
    def __init__(
        ...
        self._factory = ConfigChainFactory(
            session,
            environ,
        )
    ...
    def create_config_chain(
        ...
        if (
            "instance"
            not in self._supported_methods
        ):
            instance_name = None
        if (
            "env"
