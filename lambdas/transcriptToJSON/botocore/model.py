...
class InvalidShapeReferenceError(
    Exception
):
    pass
...
class Shape:
    ...
    def __init__(
        ...
        self.type_name = shape_model[
            "type"
        ]
        self.documentation = shape_model.get(
            "documentation",
            "",
        )
    ...
    def _resolve_shape_ref(
        ...
        return self._shape_resolver.resolve_shape_ref(
            shape_ref
        )
...
class StructureShape(
    ...
    def error_code(
        ...
        if not self.metadata.get(
            ...
            return None
        error_metadata = self.metadata.get(
            "error",
            {},
        )
        code = error_metadata.get(
            "code"
        )
        if code:
            return code
...
class ListShape(
    ...
    def member(
        ...
        return self._resolve_shape_ref(
            self._shape_model[
                "member"
            ]
        )
...
class ServiceModel:
    ...
    def __init__(
        ...
        self.metadata = service_description.get(
            "metadata",
            {},
        )
    ...
    def shape_for_error_code(
        self,
        error_code,
    ):
        return self._error_code_cache.get(
            error_code,
            None,
        )

    @CachedProperty
    def _error_code_cache(
        self,
    ):
        error_code_cache = (
            {}
    ...
    def error_shapes(
        ...
        for shape_name in (
            ...
            error_shape = self.shape_for(
                shape_name
            )
            if error_shape.metadata.get(
                "exception",
                False,
            ):
                error_shapes.append(
    ...
    def operation_model(
        ...
        try:
            model = self._service_description[
                "operations"
            ][
                operation_name
            ]
    ...
    def documentation(
        ...
        return self._service_description.get(
            "documentation",
            "",
        )
    ...
    def signing_name(
        ...
        """
        signing_name = self.metadata.get(
            "signingName"
        )
        if (
            signing_name
    ...
    def api_version(
        ...
        return self._get_metadata_property(
            "apiVersion"
        )
    ...
    @CachedProperty
    def endpoint_discovery_operation(
        self,
    ):
        for operation in (
            ...
            if (
                model.is_endpoint_discovery_operation
            ):
                return model
    ...
    def endpoint_discovery_required(
        ...
        for operation in (
            ...
            if (
                model.endpoint_discovery
                is not None
                and model.endpoint_discovery.get(
                    "required"
                )
            ):
                return True
    ...
    @CachedProperty
    def client_context_parameters(
        self,
    ):
        params = self._service_description.get(
            "clientContextParams",
            {},
        )
        return [
    ...
    def signature_version(
        ...
        if (
            ...
            signature_version = self.metadata.get(
                "signatureVersion"
            )
...
class OperationModel:
    def __init__(
        ...
        self._wire_name = operation_model.get(
            "name"
        )
        self.metadata = (
            service_model.metadata
        )
        self.http = operation_model.get(
            "http",
            {},
        )
    ...
    def wire_name(
        ...
        """
        return self._operation_model.get(
            "name"
        )
    ...
    @CachedProperty
    def is_endpoint_discovery_operation(
        self,
    ):
        return self._operation_model.get(
            "endpointoperation",
    ...
    def static_context_parameters(
        ...
        params = self._operation_model.get(
            "staticContextParams",
            {},
        )
        return [
            StaticContextParameter(
                name=name,
                value=props.get(
                    "value"
                ),
    ...
    def error_shapes(
        ...
        shapes = self._operation_model.get(
            "errors",
            [],
        )
        return list(
            self._service_model.resolve_shape_ref(
                s
            )
            for s in shapes
        )
    ...
    @CachedProperty
    def has_event_stream_input(
        self,
    ):
        return (
            self.get_event_stream_input()
            is not None
        )

    @CachedProperty
    def has_event_stream_output(
        self,
    ):
        return (
            self.get_event_stream_output()
            is not None
        )

    def get_event_stream_input(
        self,
    ):
        return self._get_event_stream(
            self.input_shape
        )

    def get_event_stream_output(
        self,
    ):
        return self._get_event_stream(
            self.output_shape
    ...
    @CachedProperty
    def has_streaming_input(
        self,
    ):
        return (
            self.get_streaming_input()
            is not None
        )

    @CachedProperty
    def has_streaming_output(
        self,
    ):
        return (
            self.get_streaming_output()
            is not None
        )
    ...
    def get_streaming_input(
        ...
        return self._get_streaming_body(
            self.input_shape
        )
    ...
    def _get_streaming_body(
        ...
        if (
            ...
            return None
        payload = shape.serialization.get(
            "payload"
        )
        if (
            payload
            ...
            payload_shape = shape.members[
                payload
            ]
            if (
                payload_shape.type_name
                == "blob"
            ):
...
class DenormalizedStructureBuilder:
    ...
    def __init__(
        ...
        if (
            ...
            self.name = self._name_generator.new_shape_name(
                "structure"
            )
    ...
    def _build_model(
        ...
        if (
            ...
            raise InvalidShapeError(
                f"Unknown shape type: {model['type']}"
            )
    ...
    def _build_structure(
        ...
        shape = self._build_initial_shape(
            model
        )
        shape[
            "members"
        ...
        for (
            ...
            member_shape_name = self._get_shape_name(
                member_model
            )
            members[
                name
    ...
    def _build_map(
        ...
        key_shape_name = self._get_shape_name(
            model[
                "key"
            ]
        )
        value_shape_name = self._get_shape_name(
            model[
                "value"
            ]
        )
    ...
    def _build_scalar(
        ...
        return self._build_initial_shape(
            model
        )
    ...
    def _get_shape_name(
        ...
        if (
            ...
            return self._name_generator.new_shape_name(
                model[
                    "type"
                ]
            )
...
class ShapeNameGenerator:
    ...
    def new_shape_name(
        ...
        current_index = self._name_cache[
            type_name
        ]
