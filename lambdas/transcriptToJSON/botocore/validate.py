...
def type_check(
    ...
    def _create_type_check_guard(
        func,
    ):
        def _on_passes_type_check(
            self,
            param,
            shape,
            errors,
...
class ParamValidator:
    ...
    def _check_special_validation_cases(
        self,
        shape,
    ):
        if is_json_value_header(
            ...
            return (
                self._validate_jsonvalue_string
            )
        if (
            shape.type_name
            == "structure"
            and shape.is_document_type
        ):
            return (
    ...
    def _validate(
        ...
        special_validator = self._check_special_validation_cases(
            shape
        )
    ...
    def _validate_jsonvalue_string(
        self,
        params,
        shape,
        errors,
    ...
    def _validate_structure(
        ...
        for required_member in shape.metadata.get(
            "required",
            [],
        ):
            if (
    ...
    def _validate_timestamp(
        ...
        is_valid_type = self._type_check_datetime(
            param
        )
        if (
            not is_valid_type
