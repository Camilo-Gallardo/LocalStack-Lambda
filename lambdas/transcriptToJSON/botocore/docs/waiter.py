...
class WaiterDocumenter:
    ...
    def document_waiters(
        ...
        for waiter_name in (
            self._service_waiter_model.waiter_names
        ):
            section.style.tocitem(
                f"{self._service_name}/waiter/{waiter_name}"
            )
            ...
            waiter_doc_structure.write_to_file(
                waiter_dir_path,
                waiter_name,
            )

    def _add_single_waiter(
        self,
        section,
        waiter_name,
    ):
        ...
        waiter_section = section.add_new_section(
            waiter_name
        )
