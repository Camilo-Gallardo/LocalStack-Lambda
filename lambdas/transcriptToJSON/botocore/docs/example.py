...
class BaseExampleDocumenter(
    ...
    def document_example(
        ...
        final_blank_line_section = section.add_new_section(
            "final-blank-line"
        )
    ...
    def document_shape_default(
        ...
        **kwargs
        ...
        py_type = self._get_special_py_default(
            shape
        )
        if (
            py_type
    ...
    def document_shape_type_list(
        ...
        **kwargs
        ...
        ending_comma_section = list_section.add_new_section(
            "ending-comma"
        )
    ...
    def document_shape_type_structure(
        ...
        **kwargs
        ...
        input_members = self._add_members_to_shape(
            shape.members,
            include,
        )
    ...
    def document_shape_type_map(
        ...
        **kwargs
        ...
        map_section = section.add_new_section(
            "map-value"
        )
        self._start_nested_param(
            map_section,
        ...
        end_bracket_section = map_section.add_new_section(
            "ending-bracket"
        )
        self._end_nested_param(
            end_bracket_section,
    ...
    def _end_structure(
        ...
        if (
            not section.available_sections
        ):
            section.clear_text()
            section.write(
                start
            ...
            end_bracket_section = section.add_new_section(
                "ending-bracket"
            )
            self._end_nested_param(
                end_bracket_section,
...
class RequestExampleDocumenter(
    BaseExampleDocumenter
):
