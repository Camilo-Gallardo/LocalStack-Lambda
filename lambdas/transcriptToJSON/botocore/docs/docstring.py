...
class LazyLoadedDocstring(
    ...
    def expandtabs(
        ...
        if (
            ...
            self._generate()
        return self._docstring.expandtabs(
            tabsize
        )
    ...
    def _create_docstring(
        ...
        return docstring_structure.flush_structure().decode(
            "utf-8"
        )
