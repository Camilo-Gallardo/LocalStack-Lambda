...
class SharedExampleDocumenter:
    ...
    def document_input(
        ...
        input_section = section.add_new_section(
            "input"
        )
        ...
        param_section = input_section.add_new_section(
            "parameters"
        )
        ...
        closing_section = input_section.add_new_section(
            "input-close"
        )
        closing_section.style.new_line()
        closing_section.style.new_line()
        closing_section.write(
            "print(response)"
        )
    ...
    def document_output(
        ...
        output_section = section.add_new_section(
            "output"
        )
        ...
        closing_section = output_section.add_new_section(
            "output-close"
        )
        closing_section.style.end_codeblock()
    ...
    def _document_dict(
        ...
        dict_section = section.add_new_section(
            "dict-value"
        )
        self._start_nested_value(
            dict_section,
            "{",
        )
        for (
            ...
            item_section = dict_section.add_new_section(
                key
            )
            item_section.style.new_line()
            item_comment = self._get_comment(
                path,
                comments,
            )
            if item_comment:
            ...
            path.pop()
        dict_section_end = dict_section.add_new_section(
            "ending-brace"
        )
        self._end_nested_value(
            dict_section_end,
            "}",
        )
        if (
    ...
    def _document_params(
        ...
        for (
            ...
            item_section = param_section.add_new_section(
                key
            )
            item_section.style.new_line()
            item_comment = self._get_comment(
            ...
            path.pop()
        param_section_end = param_section.add_new_section(
            "ending-parenthesis"
        )
        self._end_nested_value(
            param_section_end,
    ...
    def _document_list(
        ...
        list_section = section.add_new_section(
            "list-section"
        )
        self._start_nested_value(
            list_section,
        ...
        for (
            ...
            item_section = list_section.add_new_section(
                index
            )
            item_section.style.new_line()
            path.append(
            ...
            path.pop()
        list_section_end = list_section.add_new_section(
            "ending-bracket"
        )
        self._end_nested_value(
            list_section_end,
    ...
    def _document_datetime(
        ...
        datetime_tuple = parse_timestamp(
            value
        ).timetuple()
        datetime_str = str(
            datetime_tuple[
...
def document_shared_examples(
    ...
    """
    container_section = section.add_new_section(
        "shared-examples"
    )
    container_section.style.new_paragraph()
    container_section.style.bold(
        "Examples"
    )
    documenter = (
    ...
    for example in shared_examples:
        documenter.document_shared_example(
            example=example,
            section=container_section.add_new_section(
                example[
                    "id"
                ]
            ),
