...
class ServiceDocumenter:
    ...
    def document_service(
        ...
        self.client_context_params(
            context_params_section
        )
        return (
            doc_structure.flush_structure()
        )
    ...
    def title(
        ...
        self._event_emitter.emit(
            f"docs.title.{self._service_name}",
            section=section,
        )
    ...
    def table_of_contents(
        ...
        section.style.table_of_contents(
    ...
    def paginator_api(
        ...
        try:
            ...
            return
        if (
            service_paginator_model._paginator_config
        ):
            ...
            paginator_documenter.document_paginators(
                section
            )
    ...
    def waiter_api(
        ...
        if (
            ...
            waiter_documenter.document_waiters(
                section
            )
    ...
    def get_examples(
        ...
        loader = self._session.get_component(
            "data_loader"
        )
    ...
    def client_context_params(
        self,
        section,
    ):
        omitted_params = (
            ClientContextParamsDocumenter.OMITTED_CONTEXT_PARAMS
        )
        params_to_omit = omitted_params.get(
            self._service_name,
            [],
        )
        service_model = (
        ...
        context_params = [
            p
            for p in raw_context_params
            if p.name
            not in params_to_omit
        ]
        if context_params:
            ...
            context_param_documenter.document_context_params(
                section
            )
