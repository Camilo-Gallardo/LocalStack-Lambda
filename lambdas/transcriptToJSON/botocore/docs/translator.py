...
from sphinx.writers.html5 import (
    HTML5Translator as SphinxHTML5Translator,
)


class BotoHTML5Translator(
    SphinxHTML5Translator
):
    ...
    def is_implicit_heading(
        ...
        return (
            ...
            not in self.IGNORE_IMPLICIT_HEADINGS
        )
