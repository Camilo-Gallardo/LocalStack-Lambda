...
class ShapeDocumenter:
    ...
    def _get_special_py_default(
        ...
        return self._get_value_for_special_type(
            shape,
            special_defaults,
        )

    def _get_special_py_type_name(
        self,
        shape,
    ):
        special_type_names = {
    ...
    def _get_value_for_special_type(
        self,
        shape,
        special_type_map,
    ):
