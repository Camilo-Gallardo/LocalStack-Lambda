...
class PaginatorDocumenter:
    ...
    def _add_paginator(
        ...
        paginator_section = section.add_new_section(
            paginator_name
        )
...
def document_paginate_method(
    ...
    if isinstance(
        ...
        service_pagination_params += paginator_config[
            "input_token"
        ]
    else:
        service_pagination_params.append(
            paginator_config[
                "input_token"
            ]
        )
