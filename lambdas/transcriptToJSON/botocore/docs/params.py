...
from botocore.docs.shape import (
    ShapeDocumenter,
)
...
class BaseParamsDocumenter(
    ...
    def document_recursive_shape(
        ...
        **kwargs,
        ...
        self._add_member_documentation(
            section,
            shape,
            **kwargs,
        )
    ...
    def document_shape_type_list(
        ...
        **kwargs,
        ...
        param_section = section.add_new_section(
            param_shape.name,
            context={
                "shape": shape.member.name
            },
        )
        self._start_nested_param(
            param_section
        )
        self.traverse_and_document_shape(
    ...
    def document_shape_type_map(
        ...
        **kwargs,
        ...
        end_section = section.add_new_section(
            "end-map"
        )
        self._end_nested_param(
            end_section
    ...
    def document_shape_type_structure(
        ...
        **kwargs,
        ...
        members = self._add_members_to_shape(
            shape.members,
            include,
        )
        self._add_member_documentation(
    ...
    def _document_non_top_level_param_type(
        self,
        type_section,
        shape,
    ):
        special_py_type = self._get_special_py_type_name(
            shape
        )
        py_type = py_type_name(
            shape.type_name
        )
...
class ResponseParamsDocumenter(
    BaseParamsDocumenter
):
    ...
    def _add_member_documentation(
        ...
        **kwargs,
        ...
        name_section = section.add_new_section(
            "param-name"
        )
        name_section.write(
            "- "
        ...
        type_section = section.add_new_section(
            "param-type"
        )
        self._document_non_top_level_param_type(
            type_section,
            shape,
        )
        ...
        if (
            ...
            if getattr(
                ...
                tagged_union_docs.write(
                    note
                    % (
                        tagged_union_members_str
                    )
                )
                example = section.add_new_section(
                    "param-unknown-example"
                )
                example.style.codeblock(
                    unknown_code_example
                )
            documentation_section.include_doc_string(
                shape.documentation
            )
    ...
    def document_shape_type_event_stream(
        ...
        **kwargs,
        ...
        self.document_shape_type_structure(
            section,
            shape,
            history,
            **kwargs,
...
class RequestParamsDocumenter(
    ...
    def _add_member_documentation(
        ...
        **kwargs,
        ...
        py_type = self._get_special_py_type_name(
            shape
        )
        if (
            py_type
        ...
        if is_top_level_param:
            ...
            end_type_section = type_section.add_new_section(
                "end-param-type"
            )
        ...
        if is_required:
            is_required_section = section.add_new_section(
                "is-required"
            )
            is_required_section.style.indent()
            is_required_section.style.bold(
                "[REQUIRED]"
            )
        ...
        if (
            ...
            self._add_special_trait_documentation(
                documentation_section,
                shape,
            )
        end_param_section = section.add_new_section(
            "end-param"
        )
        end_param_section.style.new_paragraph()

    def _add_special_trait_documentation(
        self,
        section,
        shape,
    ):
        if (
            ...
            self._append_idempotency_documentation(
                section
            )

    def _append_idempotency_documentation(
        self,
        section,
    ):
