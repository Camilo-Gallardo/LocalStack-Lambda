...
class BaseStyle:
    ...
    def add_trailing_space_to_previous_write(
        self,
    ):
...
class ReSTStyle(
    ...
    def end_sphinx_py_class(
        self,
    ):
        self.dedent()
        self.new_paragraph()

    def start_sphinx_py_method(
        self,
        method_name,
        parameters=None,
    ):
    ...
    def end_sphinx_py_method(
        self,
    ):
        self.dedent()
        self.new_paragraph()

    def start_sphinx_py_attr(
        self,
        attr_name,
    ):
        self.new_paragraph()
    ...
    def end_sphinx_py_attr(
        self,
    ):
        self.dedent()
        self.new_paragraph()

    def write_py_doc_string(
        self,
        docstring,
    ):
        docstring_lines = (
