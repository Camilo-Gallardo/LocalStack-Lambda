...
class HTMLTree:
    ...
    def add_tag(
        ...
        if not self._doc_has_handler(
            tag,
            is_start,
        ):
            self.unhandled_tags.append(
                tag
            )
            return
...
class DataNode(
    ...
    def __init__(
        ...
        self._leading_whitespace = data[
            :first_non_space
        ]
        self._trailing_whitespace = data[
            last_non_space:
        ]
        self._stripped_data = data[
    ...
    def write(
        ...
        words = doc.translate_words(
            self._stripped_data.split()
        )
        str_data = (
