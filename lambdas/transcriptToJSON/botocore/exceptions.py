...
class InvalidIMDSEndpointError(
    BotoCoreError
):
    fmt = "Invalid endpoint EC2 Instance Metadata endpoint: {endpoint}"


class InvalidIMDSEndpointModeError(
    BotoCoreError
):
    fmt = (
...
class BaseEndpointResolverError(
    BotoCoreError
):
...
class UnknownFIPSEndpointError(
    BaseEndpointResolverError
):
    """
...
class AliasConflictParameterError(
    ValidationError
):
    """
...
class IncompleteReadError(
    ...
    fmt = (
        "{actual_bytes} read, but total bytes "
...
class UnknownClientMethodError(
    BotoCoreError
):
...
class UnsupportedTLSVersionWarning(
    Warning
):
...
class ImminentRemovalWarning(
    Warning
):
    pass


class InvalidDNSNameError(
    BotoCoreError
):
...
class InvalidS3AddressingStyleError(
    BotoCoreError
):
...
class UnsupportedS3ControlArnError(
    BotoCoreError
):
...
class UnsupportedOutpostResourceError(
    BotoCoreError
):
...
class UnsupportedS3ConfigurationError(
    BotoCoreError
):
...
class UnsupportedS3AccesspointConfigurationError(
    BotoCoreError
):
    """Error when an unsupported configuration is used with access-points"""
...
class InvalidEndpointDiscoveryConfigurationError(
    BotoCoreError
):
...
class UnsupportedS3ControlConfigurationError(
    BotoCoreError
):
...
class InvalidRetryConfigurationError(
    BotoCoreError
):
...
class InvalidMaxRetryAttemptsError(
...
class InvalidS3UsEast1RegionalEndpointConfigError(
    BotoCoreError
):
...
class InvalidSTSRegionalEndpointsConfigError(
    BotoCoreError
):
...
class RefreshWithMFAUnsupportedError(
    BotoCoreError
):
    fmt = "Cannot refresh credentials: MFA token required."


class MD5UnavailableError(
    BotoCoreError
):
...
class UndefinedModelAttributeError(
    Exception
):
    pass


class MissingServiceIdError(
...
class CapacityNotAvailableError(
    BotoCoreError
):
...
class FlexibleChecksumError(
    BotoCoreError
):
    fmt = "{error_msg}"


class InvalidEndpointConfigurationError(
    BotoCoreError
):
    fmt = "Invalid endpoint configuration: {msg}"


class EndpointProviderError(
    BotoCoreError
):
...
class UnknownEndpointResolutionBuiltInName(
    EndpointProviderError
):
