...
class Config:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if (
            ...
            config_vars.update(
                self.NON_LEGACY_OPTION_DEFAULTS
            )
        config_vars.update(
            self._user_provided_options
        )
    ...
    def _record_user_provided_options(
        self,
        args,
        kwargs,
    ):
    ...
    def merge(
        ...
        config_options.update(
            other_config._user_provided_options
        )
