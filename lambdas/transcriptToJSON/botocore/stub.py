...
class Stubber:
    ...
    **Example:**
    ...
    def _add_response(
        ...
        operation_name = self.client.meta.method_to_api_mapping.get(
            method
        )
    ...
    def add_client_error(
        ...
        if (
            ...
            shape = service_model.shape_for_error_code(
                service_error_code
            )
    ...
    def assert_no_pending_responses(
        self,
    ):
        """
        ...
        if (
            ...
            raise AssertionError(
                f"{remaining} responses remaining in queue."
            )
    ...
    def _get_response_handler(
        ...
        **kwargs,
        ...
        self._assert_expected_call_order(
            model,
            params,
        )
