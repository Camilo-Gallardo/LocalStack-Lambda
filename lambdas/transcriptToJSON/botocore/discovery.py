...
class EndpointDiscoveryRequired(
...
class EndpointDiscoveryRefreshFailed(
    EndpointDiscoveryException
):
...
def block_endpoint_discovery_required_operations(
    model,
    **kwargs
):
    endpoint_discovery = (
...
class EndpointDiscoveryModel:
    ...
    @CachedProperty
    def discovery_operation_name(
        self,
    ):
        discovery_operation = (
            self._service_model.endpoint_discovery_operation
        )
        return xform_name(
            discovery_operation.name
        )

    @CachedProperty
    def discovery_operation_keys(
        self,
    ):
        discovery_operation = (
            self._service_model.endpoint_discovery_operation
        ...
        if (
            discovery_operation.input_shape
        ):
            keys = list(
                discovery_operation.input_shape.members.keys()
            )
        return keys

    def discovery_required_for(
        self,
        operation_name,
    ):
        try:
            ...
            return operation_model.endpoint_discovery.get(
                "required",
                False,
            )
    ...
    def discovery_operation_kwargs(
        self,
        **kwargs
    ):
        input_keys = (
            self.discovery_operation_keys
        )
...
class EndpointDiscoveryManager:
    def __init__(
        ...
        self._model = EndpointDiscoveryModel(
    ...
    def _create_cache_key(
        ...
        **kwargs
        ...
        kwargs = self._model.discovery_operation_kwargs(
            **kwargs
        )
        return tuple(
            self._cache_item(
    ...
    def gather_identifiers(
        ...
        return self._model.gather_identifiers(
            operation,
            params,
        )
    ...
    def _describe_endpoints(
        ...
        **kwargs
        ...
        operation_name = (
            self._model.discovery_operation_name
        )
        discovery_operation = getattr(
            self._client,
            operation_name,
        )
        logger.debug(
            "Discovering endpoints with kwargs: %s",
            kwargs,
        )
    ...
    def _refresh_current_endpoints(
        self,
        **kwargs
    ):
        cache_key = self._create_cache_key(
        ...
        try:
            response = self._describe_endpoints(
                **kwargs
            )
    ...
    def describe_endpoint(
        ...
        **kwargs
        ...
        discovery_required = self._model.discovery_required_for(
            operation
        )

        if (
            not self._always_discover
            and not discovery_required
        ):
        ...
        recently_failed = self._recently_failed(
            cache_key
        )
        if (
            not recently_failed
            ...
            endpoints = self._refresh_current_endpoints(
                **kwargs
            )
            if endpoints:
                return self._select_endpoint(
        ...
        logger.debug(
            "Endpoint Discovery has failed for: %s",
            kwargs,
        )
        stale_entries = self._cache.get(
            cache_key,
            None,
        )
        if stale_entries:
...
class EndpointDiscoveryHandler:
    ...
    def register(
        ...
        events.register(
            "before-parameter-build.%s"
            % service_id,
            self.gather_identifiers,
        )
    ...
    def gather_identifiers(
        ...
        **kwargs
        ...
        if (
            ...
            return
        ids = self._manager.gather_identifiers(
            model,
            params,
        )
        context[
    ...
    def discover_endpoint(
        ...
        **kwargs
        ...
        logger.debug(
            "Injecting discovered endpoint: %s",
            endpoint,
        )
