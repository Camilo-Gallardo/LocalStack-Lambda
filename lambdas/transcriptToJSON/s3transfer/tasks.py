...
class Task:
    ...
    def _execute_main(
        ...
        if (
            ...
            self._transfer_coordinator.set_result(
                return_value
            )
        return return_value
    ...
    def _wait_on_dependent_futures(
        ...
        for (
            ...
            self._pending_main_kwargs.items()
        ):
...
class CompleteMultipartUploadTask(
    Task
):
