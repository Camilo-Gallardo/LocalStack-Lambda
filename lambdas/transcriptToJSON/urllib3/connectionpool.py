...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def _validate_conn(self, conn: BaseHTTPConnection) -> None:
        ...
        if not conn.is_verified:
            warnings.warn(
                (f"Unverified HTTPS request is being made to host '{conn.host}'. " "Adding certificate verification is strongly advised. See: " "https://urllib3.readthedocs.io/en/latest/advanced-usage.html" "#tls-warnings"),
                InsecureRequestWarning,
            )
