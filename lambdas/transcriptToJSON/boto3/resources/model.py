...
class Waiter(
    ...
    def __init__(
        ...
        self.waiter_name = definition.get(
            "waiterName"
        )
...
class Collection(
    ...
    def batch_actions(
        ...
        """
        return (
            self.resource.model.batch_actions
        )
...
class ResourceModel:
    ...
    def load_rename_map(
        ...
        * Attributes (shape members)
        ...
        for (
            ...
            self._get_has_definition().items()
        ):
    ...
    def _load_name_with_category(
        ...
        if (
            ...
            logger.debug(
                f"Renaming {self.name} {category} {name}"
            )
            self._renamed[
                (
                    category,
    ...
    def subresources(
        ...
        :type: list(:py:class:`Action`)
        """
        return self._get_related_resources(
            True
        )
