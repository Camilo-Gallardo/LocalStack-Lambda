...
class ResourceFactory:
    ...
    def load_from_definition(
        ...
        resource_model.load_rename_map(
            shape
        )
    ...
    def _load_attributes(
        ...
        attributes = resource_model.get_attributes(
            shape
        )
        for (
            name,
    ...
    def _create_available_subresources_command(
        self,
        attrs,
        subresources,
    ):
    ...
    def _create_autoload_property(
        ...
        def property_loader(
            ...
            return self.meta.data.get(
                name
            )

        property_loader.__name__ = str(
            snake_cased
        )
    ...
    def _create_reference(
        ...
        needs_data = any(
            i.source
            == "data"
            for i in reference_model.resource.identifiers
        )
    ...
    def _create_class_partial(
        ...
        """
        name = (
            subresource_model.resource.type
        )
        ...
        def create_resource(
            ...
            **kwargs,
            ...
            json_def = service_context.resource_json_definitions.get(
                name,
                {},
            )
            ...
            identifiers = (
                subresource_model.resource.identifiers
            )
            if (
                identifiers
                is not None
