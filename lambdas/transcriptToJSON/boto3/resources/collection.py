...
class ResourceCollection:
    ...
    def pages(
        ...
        """
        client = (
            self._parent.meta.client
        )
        cleaned_params = (
            self._params.copy()
        )
        limit = cleaned_params.pop(
            "limit",
            None,
        )
        page_size = cleaned_params.pop(
            "page_size",
            None,
        )
...
class CollectionManager:
    ...
    def __init__(
        ...
        operation_name = (
            self._model.request.operation
        )
        self._parent = parent

        search_path = (
            collection_model.resource.path
        )
    ...
    all.__doc__ = (
        ResourceCollection.all.__doc__
    )
    ...
    filter.__doc__ = (
        ResourceCollection.filter.__doc__
    )
    ...
    limit.__doc__ = (
        ResourceCollection.limit.__doc__
    )
    ...
    pages.__doc__ = (
        ResourceCollection.pages.__doc__
    )
...
class CollectionFactory:
    ...
    def _load_batch_actions(
        ...
        """
        for action_model in (
            collection_model.batch_actions
        ):
            snake_cased = xform_name(
                action_model.name
            )
            attrs[
                snake_cased
            ] = self._create_batch_action(
                resource_name,
                snake_cased,
                action_model,
                collection_model,
