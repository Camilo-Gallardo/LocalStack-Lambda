...
class ConditionBase:
    ...
    def __and__(
        ...
        if not isinstance(
            ...
            raise DynamoDBOperationNotSupportedError(
                "AND",
                other,
            )
        return And(
...
class ConditionAttributeBase(
    ...
    def __eq__(
        ...
        return ConditionBase.__eq__(
            self,
            other,
        ) and AttributeBase.__eq__(
            self,
            other,
        )
...
class ConditionExpressionBuilder:
    ...
    def _get_name_placeholder(
        self,
    ):
        return "#" + self._name_placeholder + str(self._name_count)

    def _get_value_placeholder(
        self,
    ):
    ...
    def _build_expression(
        ...
        return expression_dict["format"].format(
            *replaced_values,
            operator=expression_dict["operator"],
        )
    ...
    def _build_expression_component(
        ...
        # its name
            ...
            if is_key_condition and not isinstance(
                value,
                Key,
            ):
    ...
    def _build_name_placeholder(
        ...
        placeholder_format = ATTR_NAME_REGEX.sub(
            "%s",
            attribute_name,
        )
        str_format_args = []
