...
class Session:
    ...
    def __init__(
        ...
        if (
            ...
            self._session.set_config_variable(
                "profile",
                profile_name,
            )
    ...
    def __repr__(
        ...
        return "{}(region_name={})".format(
            ...
            repr(
                self._session.get_config_variable(
                    "region"
                )
            ),
        )
    ...
    def region_name(
        ...
        """
        return self._session.get_config_variable(
            "region"
        )
    ...
    def events(
        ...
        """
        return self._session.get_component(
            "event_emitter"
        )
    ...
    def available_profiles(
        ...
        """
        return (
            self._session.available_profiles
        )
    ...
    def _setup_loader(
        ...
        """
        self._loader = self._session.get_component(
            "data_loader"
        )
    ...
    def get_available_services(
        ...
        """
        return (
            self._session.get_available_services()
        )
    ...
    def get_available_resources(
        ...
        :return: List of service names
        """
        return self._loader.list_available_services(
            type_name="resources-1"
        )
    ...
    def get_available_partitions(
        ...
        """
        return (
            self._session.get_available_partitions()
        )
    ...
    def get_partition_for_region(
        ...
        """
        return self._session.get_partition_for_region(
            region_name
        )
    ...
    def resource(
        ...
        service_context = boto3.utils.ServiceContext(
            ...
            resource_json_definitions=resource_model[
                "resources"
            ],
