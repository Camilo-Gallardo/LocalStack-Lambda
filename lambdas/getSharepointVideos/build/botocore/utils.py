...
def merge_dicts(
    ...
    for key in dict2:
        ...
        # append the new values onto the original list
            ...
            # values onto it.
            if key in dict1 and isinstance(
                dict1[key],
                list,
            ):
...
def calculate_tree_hash(
    ...
    for chunk in iter(
        lambda: body.read(required_chunk_size),
        b"",
    ):
...
class S3RegionRedirectorv2:
    ...
    def redirect_from_error(
        ...
        **kwargs,
        ...
        error = response[1].get(
            "Error",
            {},
        )
        error_code = error.get("Code")
        response_metadata = response[1].get(
            "ResponseMetadata",
            {},
        )
