...
def _is_script(
    ...
    return intranges_contain(
        ord(cp),
        idnadata.scripts[script],
    )
...
def check_label(
    ...
    for (
        ...
        if intranges_contain(
            ...
            cp_value,
            idnadata.codepoint_classes["CONTEXTJ"],
        ):
            try:
                if not valid_contextj(
                    label,
                    pos,
                ):
            ...
            cp_value,
            idnadata.codepoint_classes["CONTEXTO"],
        ):
            if not valid_contexto(
                label,
                pos,
            ):
                raise InvalidCodepointContext(
