...
class ClientArgsCreator:
    ...
    def get_client_args(
        ...
        partition = endpoint_config["metadata"].get(
            "partition",
            None,
        )
    ...
    def compute_client_args(
        ...
        endpoint_variant_tags = endpoint_config["metadata"].get(
            "tags",
            [],
        )
    ...
    def _compute_s3_endpoint_config(
        ...
        **resolve_endpoint_kwargs,
        ...
        self._set_region_if_custom_s3_endpoint(
            endpoint_config,
            resolve_endpoint_kwargs["endpoint_bridge"],
        )
    ...
    def _should_force_s3_global(
        ...
        is_global_region = region_name in (
            "us-east-1",
            None,
        )
        ...
        **resolve_endpoint_kwargs,
        ...
        if self._should_set_global_sts_endpoint(
            ...
            self._set_global_sts_endpoint(
                endpoint_config,
                resolve_endpoint_kwargs["is_secure"],
            )
        return endpoint_config
