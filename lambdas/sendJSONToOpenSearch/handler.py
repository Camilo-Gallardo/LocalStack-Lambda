...
def get_mission_folders(
    ...
    mission_folders = list_sharepoint_files(
        access_token,
        FOLDER_ID,
    )
...
def handler(
    ...
    for mission_folder in mission_folders:
        ...
        mission_name = mission_folder.get(
            "name",
            "",
        )
        ...
        video_folder_id = get_subfolder_by_name(
            access_token,
            mission_id,
            "video",
        )
        ...
        video_files = list_sharepoint_files(
            access_token,
            video_folder_id,
        )
        ...
        for video in video_files:
            video_name_normalized = normalize_filename(
                video.get(
                    "name",
                    "",
                )
