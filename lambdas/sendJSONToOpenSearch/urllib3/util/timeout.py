...
_DEFAULT_TIMEOUT: Final[
    _TYPE_DEFAULT
] = (
    _TYPE_DEFAULT.token
)

_TYPE_TIMEOUT = typing.Optional[
    typing.Union[
        float,
        _TYPE_DEFAULT,
    ]
...
class Timeout:
    ...
    def __init__(
        ...
        self._connect = self._validate_timeout(
            connect,
            "connect",
        )
        self._read = self._validate_timeout(
            read,
            "read",
        )
        self.total = self._validate_timeout(
            total,
            "total",
        )
        self._start_connect: (
    ...
    def read_timeout(
        ...
        if (
            ...
            return self.resolve_default_timeout(
                self._read
            )
