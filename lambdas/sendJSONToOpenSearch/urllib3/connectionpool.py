...
class ConnectionPool:
    ...
    def __init__(
        ...
        self._tunnel_host = normalize_host(
            host,
            scheme=self.scheme,
        ).lower()
    ...
    def _make_request(
        ...
        # so we need to wrap errors with 'ProxyError' here too.
            ...
            if isinstance(
                ...
                conn
                and conn.proxy
                and not conn.has_connected_to_proxy
            ):
                new_e = _wrap_proxy_error(
                    new_e,
                    conn.proxy.scheme,
                )
            raise new_e
