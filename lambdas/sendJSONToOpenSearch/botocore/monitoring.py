...
class MonitorEventAdapter:
    ...
    def _is_retryable_exception(
        ...
        return isinstance(
            exception,
            tuple(RETRYABLE_EXCEPTIONS["GENERAL_CONNECTION_ERROR"]),
        )
    ...
    def _serialize_response_headers(
        ...
        **kwargs,
        ...
        for (
            header,
            entry,
        ) in self._RESPONSE_HEADERS_TO_EVENT_ENTRIES.items():
