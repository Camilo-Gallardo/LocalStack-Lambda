...
from boto3.docs.base import (
    BaseDocumenter,
)
from boto3.docs.collection import (
    CollectionDocumenter,
)
from boto3.docs.subresource import (
...
class ResourceDocumenter(BaseDocumenter):
    ...
    def _add_overview_of_member_type(
        self,
        section,
    ...
    def _add_identifiers(
        ...
        for identifier in identifiers:
            ...
            identifier_doc.write_to_file(
                identifiers_dir_path,
                identifier.name,
            )

        if identifiers:
            self._add_overview_of_member_type(
                section,
                "identifiers",
            )
    ...
    def _add_attributes(
        ...
        for attr_name in sorted(attributes):
            ...
            attribute_doc = DocumentStructure(
                attr_name,
                target="html",
            )
    ...
    def _add_references(
        ...
        for reference in references:
            ...
            reference_doc = DocumentStructure(
                reference.name,
                target="html",
            )
